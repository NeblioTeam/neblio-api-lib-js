...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NeblioRestApiSuite.IssueTokenRequestMetadataEncryptions();
  });
  ...
  describe('IssueTokenRequestMetadataEncryptions', function() {
    it('should create an instance of IssueTokenRequestMetadataEncryptions', function() {
      ...
      //var instane = new NeblioRestApiSuite.IssueTokenRequestMetadataEncryptions();
      //expect(instance).to.be.a(NeblioRestApiSuite.IssueTokenRequestMetadataEncryptions);
    });
