...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NeblioRestApiSuite.GetTxResponseVin();
  });
  ...
  describe('GetTxResponseVin', function() {
    it('should create an instance of GetTxResponseVin', function() {
      ...
      //var instane = new NeblioRestApiSuite.GetTxResponseVin();
      //expect(instance).to.be.a(NeblioRestApiSuite.GetTxResponseVin);
    });
