...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NeblioRestApiSuite.IssueTokenRequestMetadataRulesHolders();
  });
  ...
  describe('IssueTokenRequestMetadataRulesHolders', function() {
    it('should create an instance of IssueTokenRequestMetadataRulesHolders', function() {
      ...
      //var instane = new NeblioRestApiSuite.IssueTokenRequestMetadataRulesHolders();
      //expect(instance).to.be.a(NeblioRestApiSuite.IssueTokenRequestMetadataRulesHolders);
    });
