...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NeblioRestApiSuite.GetStatusResponse();
  });
  ...
  describe('GetStatusResponse', function() {
    it('should create an instance of GetStatusResponse', function() {
      ...
      //var instane = new NeblioRestApiSuite.GetStatusResponse();
      //expect(instance).to.be.a(NeblioRestApiSuite.GetStatusResponse);
    });
