...
import GetTokenMetadataResponseMetadataOfIssuence from './GetTokenMetadataResponseMetadataOfIssuence';
...
class GetTokenMetadataResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('metadataOfIssuence')) {
                obj['metadataOfIssuence'] = GetTokenMetadataResponseMetadataOfIssuence.constructFromObject(data['metadataOfIssuence']);
            }
            if (data.hasOwnProperty('metadataOfUtxo')) {
                obj['metadataOfUtxo'] = GetTokenMetadataResponseMetadataOfIssuence.constructFromObject(data['metadataOfUtxo']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/GetTokenMetadataResponseMetadataOfIssuence} metadataOfIssuence
 */
GetTokenMetadataResponse.prototype['metadataOfIssuence'] = undefined;

/**
 * @member {module:model/GetTokenMetadataResponseMetadataOfIssuence} metadataOfUtxo
 */
