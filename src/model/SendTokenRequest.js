...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/IssueTokenRequestFlags', 'model/IssueTokenRequestMetadata', 'model/SendTokenRequestTo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./IssueTokenRequestFlags'), require('./IssueTokenRequestMetadata'), require('./SendTokenRequestTo'));
  } else {
    // Browser globals (root is window)
    if (!root.NeblioRestApiSuite) {
      root.NeblioRestApiSuite = {};
    }
    root.NeblioRestApiSuite.SendTokenRequest = factory(root.NeblioRestApiSuite.ApiClient, root.NeblioRestApiSuite.IssueTokenRequestFlags, root.NeblioRestApiSuite.IssueTokenRequestMetadata, root.NeblioRestApiSuite.SendTokenRequestTo);
  }
}(this, function(ApiClient, IssueTokenRequestFlags, IssueTokenRequestMetadata, SendTokenRequestTo) {
  'use strict';
   ...
   */
  exports.prototype['sendutxo'] = undefined;
  /**
